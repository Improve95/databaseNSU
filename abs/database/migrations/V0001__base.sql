...
create table user_role (
    ...
    role_id int references roles(id) unique
);
...
create table credit_tariffs (
    ...
    up_to_credit_period interval,
    credit_percent int
);
insert into credit_tariffs (type, up_to_amount, up_to_credit_period, credit_percent)
VALUES ('t1', 1000000, interval '2 years', 16),
       ('t2', 2000000, interval '3 years', 16),
       ('t3', 3000000, interval '4 years', 15),
       ('t4', 4000000, interval '5 years', 15),
       ('t5', 5000000, interval '6 years', 14);
...
create table credit_requests (
    id bigint primary key generated by default as identity,
    credit_tariff int references credit_tariffs("id"),
...
create table credits (
    id bigint primary key generated by default as identity,
    initial_debt numeric(15, 2),
    taking_date date default current_date,
    percent int,
    credit_period interval,
    month_amount numeric(15, 2),
    user_id int,
    credit_tariff_id int,
    foreign key (user_id, credit_tariff_id) references credit_tariff_client (user_id, credit_tariff_id)
);
