...
insert into credit_tariffs (type, initial_amount, final_amount, payment_period, credit_percent)
VALUES ('t1', 100000, 1000000, interval '2 years', 16),
       ('t2', 200000, 2000000, interval '3 years', 16),
       ('t3', 300000, 3000000, interval '4 years', 15),
       ('t4', 400000, 4000000, interval '5 years', 15),
       ('t5', 500000, 5000000, interval '6 years', 14);
