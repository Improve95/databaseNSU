...
/*alter table staff add constraint staff_passport_series_check check ( passport_series like '\d{4}' );
...
alter table staff add constraint staff_passport_number_check check ( passport_number like '\d{6}' );
